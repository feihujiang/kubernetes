...
// This is the fake algorithm provider for the scheduler.
package fake
...
func init() {
	factory.RegisterAlgorithmProvider(factory.FakeProvider, fakePredicates(), fakePriorities())
...
func fakePredicates() sets.String {
...
func fakePriorities() sets.String {
	return sets.NewString(
